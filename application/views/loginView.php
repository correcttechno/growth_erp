                ...
                <form action="<?=base_url('login/submit');?>" method="POST">
                    <div class="mb-24">
                        ...
                        <div class="position-relative">
                            <input type="text" class="form-control py-11 ps-40" name="username" id="fname" placeholder="Type your username">
                    ...
                    <p class="mt-32 text-gray-600 text-center">New on our platform?
                        <a href="<?=base_url('register');?>" class="text-main-600 hover-text-decoration-underline">Create an account</a>
                    </p>
