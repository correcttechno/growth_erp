            ...
            <table id="assignmentTable" class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="h6 mb-0 fw-medium text-gray-300"><?=$r['title'];?></span>
                        </td>
                        <td>
                            <span class="h6 mb-0 fw-medium text-gray-300"><?=$r['date'];?></span>
                        </td>
                        
                      
                        <td>
                            <a data-delete-id="<?=$r['id'];?>" class="flex-shrink-0 file-btn w-40 h-40 flex-center bg-danger-50 rounded-circle hover-bg-danger-100 transition-2">
                ...
                <form action="<?=base_url('departments/add');?>" method="post">
                    <div class="row">
                        <div class="col-12 mb-20">
                            <label class="form-label fw-semibold text-primary-light text-sm mb-8">Departamnet adı: </label>
