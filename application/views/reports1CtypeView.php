    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                <li><span class="text-main-600 fw-normal text-20">1C Hesabat növləri</span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
    ...
    <div class="modal-dialog modal-md modal-dialog modal-dialog-centered">
        <div class="modal-content radius-16 bg-base">
            ...
            <div class="modal-body p-24">
                <form action="<?=base_url('reports1c_type/add');?>" method="post">
                    <div class="row">
...
<?php $this->modal_model->delete("reports1c_type");?>